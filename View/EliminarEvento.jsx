        ...
        <View style={styles.textBoxContainer}>
            <View style={styles.Box}>
                        ...
                        <View style={styles.Title}>
                            ...
                            <Text style={styles.textWhite}>eliminar esta <Text style={styles.textPurple}>Evento </Text><Text style={styles.textWhite}>?</Text></Text>

                            <View style={{marginTop: "10%"}}/>


                            <Text style={styles.Smalltextwhite}>Bragança - Mirandela</Text>
